...
export default function Home() {
  ...
  return (
    <>
      ...
      <Text className="titleGallery">Pergolado Madeira Roliça Eucalipto </Text>
        <Box  className="gridallgalery">
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto.jpg" />
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto2.jpg" />
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto3.jpg" />
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto4.jpg" />
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto5.jpg" />

         
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto8.jpg" />
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto9.jpg" />
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto6.jpg" />
          <Image src="/images/pergolado/pergoladomadeirarolicaeucalipto7.jpeg" />
        </Box>
      </Box>
