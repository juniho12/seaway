...
export default function Home() {
  ...
  return (
    <>
      ...
      <Text className="titleGallery"> Pergolado Madeira Serrada </Text>
        <Box  className="gridallgalery">
          <Image src="/images/pergolado/pergoladomadeiraserrada.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada1.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada2.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada3.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada4.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada5.jpg" />

          <Image src="/images/pergolado/pergoladomadeiraserrada7.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada8.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada9.jpg" />
          <Image src="/images/pergolado/pergoladomadeiraserrada10.jpg" />
        </Box>
      </Box>
