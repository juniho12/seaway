...
export default function Home() {
  ...
  return (
    <>
      ...
      <Text className="titleGallery"> Assoalho </Text>
        <Box  className="gridallgalery">
          <Image src="/images/assoalho/assoalho.jpg" />
          <Image src="/images/assoalho/assoalho1.jpg" />
          <Image src="/images/assoalho/assoalho2.jpg" />
          <Image src="/images/assoalho/assoalho3.jpg" />
          <Image src="/images/assoalho/assoalho4.jpg" />
