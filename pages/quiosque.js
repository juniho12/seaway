...
export default function Home() {
  ...
  return (
    <>
      ...
      <Text className="titleGallery"> Quiosque </Text>
        <Box  className="gridallgalery">
          <Image src="/images/quiosque/quiosque.jpg" />
          <Image src="/images/quiosque/quiosque2.jpg" />
          <Image src="/images/quiosque/quiosque3.jpg" />
          <Image src="/images/quiosque/quiosque4.jpg" />
          <Image src="/images/quiosque/quiosque6.jpg" />
          <Image src="/images/quiosque/quiosque7.jpg" />
          <Image src="/images/quiosque/quiosque8.jpg" />
          <Image src="/images/quiosque/quiosque9.jpg" />
          <Image src="/images/quiosque/quiosque10.jpg" />
        </Box>
      </Box>
