...
export default function Home() {
  ...
  return (
    <>
      ...
      <Text className="titleGallery"> Quiosque Telha</Text>
        <Box  className="gridallgalery">
          <Image src="/images/quiosquetelha/quiosquetelha.jpg" />
          <Image src="/images/quiosquetelha/quiosquetelha2.jpg" />
          <Image src="/images/quiosquetelha/quiosquetelha1.jpg" />
          <Image src="/images/quiosquetelha/quiosquetelha3.jpg" />
